...
describe('OpenCRXService', () => {
    ...
    it('getAllSales should return a list of sales', async () => {
        const mockSales = [{
            '@href': 'sale_href',
    ...
    it('getSales should return a list of sales for a given salesman and year', async () => {
        const sid = '123';
        const year = '2023';
    ...
    it('getProduct should return a product for a given order', async () => {
        const mockOrder = {
            '@href': 'order_href',
    ...
    it('getSalesman should return a salesman for a given governmentId', async () => {
        const sid = '123';
        const mockSalesman = { objects: [{ href: "salesman_href", fullName: "Test Salesman", governmentId: sid, jobTitle: "Senior Salesman" }] };
    ...
    it('getAllSalesmen should return a list of salesmen with job title "Senior Salesman"', async () => {
        const mockSalesmen = {
            objects: [
    ...
    it('getCustomer should return a customer for a given sale', async () => {
        const mockSale = {
            '@href': 'sale_href',
            name: 'Test Sale',
            activeOn: '01.01.2024',
    ...
    it('getOrders should return a list of orders for a given sale', async () => {
        ...
        const mockOrders = {
            objects: [
                { '@href': 'order_href1', amount: '100', quantity: '2', product: { '@href': 'product_href1' }, pricePerUnit: '50' },
                { '@href': 'order_href2', amount: '200', quantity: '1', product: { '@href': 'product_href2' }, pricePerUnit: '200' }
            ]
        };
